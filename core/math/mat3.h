...
struct Mat3 {
        ...
        void operator*=(const Mat3 &b) { *this = *this * b; }
        ...
        inline static Mat3 coord_transform_mat(const Vec3 &u, const Vec3 &v,
                                               const Vec3 &w) {
            return Mat3{u, v, w};
        }
        ...
        Mat3(f32 d00, f32 d01, f32 d02, f32 d10, f32 d11, f32 d12, f32 d20,
             f32 d21, f32 d22)
            : Mat3(Vec3{d00, d01, d02}, Vec3{d10, d11, d12},
                   Vec3{d20, d21, d22}) {}
};
