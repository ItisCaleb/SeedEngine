...
namespace Seed {
enum class RenderResourceType { TEXTURE, VERTEX, CONSTANT, SHADER };
...
struct RenderResource {
    ...
    inline static std::map<std::string, RenderResource> global_resource;
    inline static std::map<std::string, RenderResource> global_shaders;
